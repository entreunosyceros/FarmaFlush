            ...
            if comp:
                ...
                if pvpiva is not None:
                    ...
                    fuentes.append({
                        ...
                        "precio_ref": None,
                        "url": comp.get("url"),
                        # El precio de Vademécum puede corresponder a otra presentación distinta
                        # (la búsqueda es aproximada). Evitamos mostrar un CN de CIMA aquí para
                        # no inducir a error al usuario.
                        "cn": "",
                        "presentacion": comp.get("titulo") or nombre_presentacion,
                    })
        except Exception:
            pass
